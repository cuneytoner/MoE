...
test-animation-pipeline-foundation:
> @./scripts/test-animation-pipeline-foundation.sh

test-animation-plan-schema:
> @./scripts/test-animation-plan-schema.sh

test-animation-plan-validator:
> @./scripts/test-animation-plan-validator.sh

test-animation-timeline-planner:
> @./scripts/test-animation-timeline-planner.sh

test-camera-animation-planner:
> @./scripts/test-camera-animation-planner.sh

test-object-transform-animation-planner:
> @./scripts/test-object-transform-animation-planner.sh

test-blender-animation-adapter-plan:
> @./scripts/test-blender-animation-adapter-plan.sh
