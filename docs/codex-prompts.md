...
M36 Animation Pipeline is active. Latest completed is M36.13 Animation Output Card API Plan. Next planned remains M36.14 Animation Output Card API. Do not implement M36.14 code until explicitly requested.
