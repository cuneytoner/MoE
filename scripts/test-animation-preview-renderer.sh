...
grep -q -- "- M36.15 Dashboard Animation Cards UI DONE" docs/milestones.md
grep -q -- "- M36.16 Animation Reference Board Selection DONE" docs/milestones.md
grep -q -- "- M36.17 M36 Phase Closure DONE" docs/milestones.md
grep -q -- "- M37.0 Media Workflow Orchestrator PLANNED" docs/milestones.md
if rg -n "M37\\.0.*DONE|M38\\.0.*DONE" README.md docs scripts --glob '!scripts/test-animation-preview-renderer.sh' --glob '!scripts/test-animation-output-card-api-plan.sh' --glob '!scripts/test-animation-output-card-api.sh' --glob '!scripts/test-dashboard-animation-cards.sh' --glob '!scripts/test-animation-reference-board-selection.sh' --glob '!scripts/test-m36-phase-closure.sh' >/dev/null; then
