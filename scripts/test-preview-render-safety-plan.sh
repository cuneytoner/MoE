...
grep -q -- "- M36.13 Animation Output Card API Plan PLANNED" "$CODEX_PROMPTS"
grep -q "Completed through Milestone 36.12: Animation Artifact Verifier" "$README"
grep -q "Milestone 36.13: Animation Output Card API Plan" "$README"
